...
CFLAGS	:= $(CFLAGS) $(DEFS) $(LABDEFS) -fgnu89-inline -O0 -fno-builtin -I$(TOP) -MD -Wall -Wno-format -Wno-unused -Werror -fno-stack-protector -gstabs -ggdb -g3  -Wno-unused-function -Wno-undefined -w
...
.PHONY: all always \
	handin tarball clean new realclean clean-labsetup distclean grade labsetup qemu
